...
function genCandles(base: number, count = 60, intervalMs = 3_600_000): Candle[] {
  ...
  for (let i = count; i >= 0; i--) {
    ...
    const time = new Date(now - i * intervalMs).toISOString().slice(0, 13) + ":00";
...
export const CANDLES: Record<string, Record<string, Candle[]>> = {
  BTC:  { "1H": genCandles(65000), "4H": genCandles(65000, 60, 14_400_000), "1D": genCandles(65000, 60, 86_400_000), "1W": genCandles(65000, 52, 604_800_000) },
  ETH:  { "1H": genCandles(3400),  "4H": genCandles(3400, 60, 14_400_000),  "1D": genCandles(3400, 60, 86_400_000),  "1W": genCandles(3400, 52, 604_800_000) },
  SOL:  { "1H": genCandles(175),   "4H": genCandles(175, 60, 14_400_000),   "1D": genCandles(175, 60, 86_400_000),   "1W": genCandles(175, 52, 604_800_000) },
  BNB:  { "1H": genCandles(590),   "4H": genCandles(590, 60, 14_400_000),   "1D": genCandles(590, 60, 86_400_000),   "1W": genCandles(590, 52, 604_800_000) },
  XRP:  { "1H": genCandles(0.61),  "4H": genCandles(0.61, 60, 14_400_000),  "1D": genCandles(0.61, 60, 86_400_000),  "1W": genCandles(0.61, 52, 604_800_000) },
  DOGE: { "1H": genCandles(0.17),  "4H": genCandles(0.17, 60, 14_400_000),  "1D": genCandles(0.17, 60, 86_400_000),  "1W": genCandles(0.17, 52, 604_800_000) },
  ADA:  { "1H": genCandles(0.48),  "4H": genCandles(0.48, 60, 14_400_000),  "1D": genCandles(0.48, 60, 86_400_000),  "1W": genCandles(0.48, 52, 604_800_000) },
  AVAX: { "1H": genCandles(38),    "4H": genCandles(38, 60, 14_400_000),    "1D": genCandles(38, 60, 86_400_000),    "1W": genCandles(38, 52, 604_800_000) },
};
